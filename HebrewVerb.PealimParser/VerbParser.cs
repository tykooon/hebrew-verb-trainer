...
using static HebrewVerb.PealimParser.VerbForm;
...
public static class VerbParser
{
    ...
    internal static VerbDto ParseToVerb(this HtmlDocument doc, bool passive = false)
    {
        ...
        var infinitive = doc.GetWordFormDto(VerbForm.Infinitive);
        ...
        if (!passive)
        {
            verbResult.FutureMs1 = doc.GetWordFormDto(ActivePastId["ms1"]);
            verbResult.FutureMp1 = doc.GetWordFormDto(ActivePastId["mp1"]);
            verbResult.FutureMs2 = doc.GetWordFormDto(ActivePastId["ms2"]);
            verbResult.FutureFs2 = doc.GetWordFormDto(ActivePastId["fs2"]);
            verbResult.FutureMp2 = doc.GetWordFormDto(ActivePastId["mp2"]);
            verbResult.FutureMs3 = doc.GetWordFormDto(ActivePastId["ms3"]);
            verbResult.FutureMp3 = doc.GetWordFormDto(ActivePastId["mp3"]);
        }
        else
        {
            verbResult.FutureMs1 = doc.GetWordFormDto(PassivePastId["ms1"]);
            verbResult.FutureMp1 = doc.GetWordFormDto(PassivePastId["mp1"]);
            verbResult.FutureMs2 = doc.GetWordFormDto(PassivePastId["ms2"]);
            verbResult.FutureFs2 = doc.GetWordFormDto(PassivePastId["fs2"]);
            verbResult.FutureMp2 = doc.GetWordFormDto(PassivePastId["mp2"]);
            verbResult.FutureMs3 = doc.GetWordFormDto(PassivePastId["ms3"]);
            verbResult.FutureMp3 = doc.GetWordFormDto(PassivePastId["mp3"]);
        }
