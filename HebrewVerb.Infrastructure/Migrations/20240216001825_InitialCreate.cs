        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Binyans = table.Column<byte>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RussianShort = table.Column<string>(type: "TEXT", nullable: false),
                    EnglishShort = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GizraVerb", x => new { x.GizrasId, x.VerbsId });
                    table.ForeignKey(
                        name: "FK_GizraVerb_Gizras_GizrasId",
                        column: x => x.GizrasId,
                        principalTable: "Gizras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GizraVerb_Verbs_VerbsId",
                        column: x => x.VerbsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrepositionId = table.Column<int>(type: "INTEGER", nullable: false),
                    TranslationId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
